/*
  ...
  Fermi motion for mesons : Daria Sokhan, University of Glasgow
  Keep/reject method : Rong Wang, IPNOrsay
*/
...
int main(int argc, char*argv[])
{
  ...
  for(long long ievt=0; ievt<ro->get_fNevts(); ievt++)
      ...
      if(iApZ == 3 || iApZ == 8 || iApZ == 21)
	{
	  ...
	  if(fmotion(rndmt, rndmphi2, Ipn, ims_flag, q, nu, W2, P, ThetakP, PhikP, 
